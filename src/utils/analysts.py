...
from src.agents.ingvar_kamprad import ingvar_kamprad_agent
from src.agents.michael_burry import michael_burry_agent
from src.agents.oleg_tinkoff import oleg_tinkoff_agent
...
ANALYST_CONFIG = {
    ...
    "ingvar_kamprad": {
        ...
        "description": "The Frugal Innovator",
        "investing_style": "Combines frugality with innovative business models, focusing on cost efficiency and customer-centric strategies.",
        "agent_func": ingvar_kamprad_agent,
        "type": "analyst",
        "order": 6,
    },
    "michael_burry": {
    ...
    "oleg_tinkoff": {
        "display_name": "Oleg Tinkoff",
        "description": "The Russian Entrepreneur",
        "investing_style": "Combines entrepreneurial insights with investment strategies, focusing on high-growth sectors and innovative business models.",
        "agent_func": oleg_tinkoff_agent,
        "type": "analyst",
        "order": 8,
    },
    "peter_lynch": {
